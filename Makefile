...
macos_dist_from_linux:
	...
	-o dist/macos-x64/ki $(SRC) -lm -lz -lcurses -lcurl -lpthread -lc++ -Wl,-platform_version,macos,11.6.0,11.3 $(LDFLAGS_OSX_DIST)
...
macos_arm_dist_from_linux: 
	...
	-o dist/macos-arm64/ki $(SRC) -lm -lz -lcurses -lcurl -lpthread -lc++ -Wl,-platform_version,macos,11.6.0,11.3 $(LDFLAGS_OSX_DIST)
