...
NOTE: We currently only support linux-x64 and macos-x64. ARM64 is the works. 32-bit is not on our prio list. On windows you can use WSL and use --target win-x64 to build .exe's.
